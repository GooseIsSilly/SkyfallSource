...
namespace TPSBR
{
    public class QuestTracker : MonoBehaviour
    {
        ...
        private void TrackSurvivalTime()
        {
            ...
            // Report survival time every 5 seconds so the UI stays responsive.
            // QuestManager uses Math.Max so only the highest value counts.
            if (_survivalTimeCounter >= 5f && Mathf.FloorToInt(_survivalTimeCounter) % 5 == 0)
            {
