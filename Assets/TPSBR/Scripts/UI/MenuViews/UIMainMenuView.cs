...
namespace TPSBR.UI
{
    public class UIMainMenuView : UIView
    {
        ...
        protected override void OnOpen()
        {
            ...
            if (TPSBR.Backend.BackendServiceManager.Instance != null && !TPSBR.Backend.BackendServiceManager.Instance.IsLoggedIn)
            {
                Open<UILoginView>();
            }
        ...
        private void OnPlayButtonOLD_DISABLED()
        {
            ...
            var request = new SessionRequest
            {
                ...
                IPAddress = DedicatedServerSettings.IPAddress,
