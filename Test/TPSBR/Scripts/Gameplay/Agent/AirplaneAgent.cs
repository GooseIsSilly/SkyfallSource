	...
	public sealed class AirplaneAgent : ContextBehaviour
	{
		...
		public override void FixedUpdateNetwork()
		{
			...
			if (Runner.TryGetInputForPlayer(Object.InputAuthority, out GameplayInput input) == true)
			{
				...
				if (HasStateAuthority == true && EGameplayInputAction.Jump.WasActivated(input, _lastKnownInput) == true)
				{
		...
		public override void Render()
		{
			...
			// Once the real Agent has been registered as the observed agent, it owns the camera.
